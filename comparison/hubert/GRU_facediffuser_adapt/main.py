...
from models import FaceDiff, FaceDiffBeat, FaceDiffBeat2, FaceDiffDamm
from utils import *
...
def main():
    ...
    parser.add_argument("--save_path", type=str, default="save_pre_cosy", help='path of the trained models')
    parser.add_argument("--result_path", type=str, default="result_BEAT2", help='path to the predictions')
    ...
    if 'damm' in args.dataset:
        ...
        print("Using FaceDiffBeat2 model (for BEAT2 dataset)")
        model = FaceDiffBeat(
            args,
