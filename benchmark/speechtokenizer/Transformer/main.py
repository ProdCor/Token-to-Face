...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Train blendshape decoder with SpeechTokenizer",
    ...
    parser.add_argument('--n_q', type=int, help='Number of RVQ levels (default: 8)')
    ...
    # Data - TOKEN PATHS (not audio!)
    parser.add_argument('--train_tokens', type=str,
                        help='Path to training speech tokens (.pt file)')
    parser.add_argument('--val_tokens', type=str,
                        help='Path to validation speech tokens (.pt file)')
    parser.add_argument('--beat2_dir', type=str,
                        help='Path to BEAT2 .npz directory')
