...
python combine_regions_batch.py \
    --dir1 results/test_set_results_100ep_GRU_CV2_cben \
    --dir2 results/test_set_results_100ep_GRU_CV2_mj \
    --output_dir results//test_set_results_100ep_GRU_CV2_combined
