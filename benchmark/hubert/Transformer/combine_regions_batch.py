...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  # Combine mouth and upper face predictions
  python combine_predictions.py \\
    --dir1 outputs/predictions/model_mouth \\
    --dir2 outputs/predictions/model_upper \\
    --output_dir outputs/predictions/combined

  # Without clipping (allow values > 1.0)
  python combine_predictions.py \\
    --dir1 outputs/predictions/model_mouth \\
    --dir2 outputs/predictions/model_upper \\
    --output_dir outputs/predictions/combined \\
